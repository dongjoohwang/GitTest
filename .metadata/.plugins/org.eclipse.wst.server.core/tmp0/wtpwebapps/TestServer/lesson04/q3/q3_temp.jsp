...
<body>
	...
	%>
		<div id="wrap">
		<jsp:include page="q3_header.jsp"/>
		<jsp:include page="q3_menu.jsp"/>
		<jsp:include page="q3_contents.jsp"/>
		<jsp:include page="q3_contents2.jsp"/>
		<jsp:include page="q3_footer.jsp"/>
		</div>
