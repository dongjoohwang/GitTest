...
<br><br>
  ...
  <a href="join.do"> <button type = "button"  class="btn_order" style="margin-left:600px;">회 원 가 입</button></a>
  <a href="hospitalMain.do"> <button type = "button"  class="btn_cancel1" style="margin-left:10px;">취 소 하 기</button></a>
