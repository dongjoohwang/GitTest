...
public class Ex11_14as {

	 static ArrayList<Student2> record = new ArrayList<>();
	      ...
	      while(true) {
	         ...
	         try {
	            if(a.equalsIgnoreCase("Q")) {
	               displaymenu();
	               System.out.println("입력부분 나갑니다.");     break;
	            }
	            ...
	            record.add(new Student2(b, q, w, e, r, t));
