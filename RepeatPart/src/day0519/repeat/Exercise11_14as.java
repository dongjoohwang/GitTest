...
import java.util.*;
	...
	static int displayMenu(){
		...
		System.out.println("*           성적 관리 프로그램            *"); // 성적 관리 프로그램
	
		System.out.println("**************************************************");
		System.out.println();
		System.out.println(" 1. 학생 성적 입력하기"); // 학생성적 입력하기
		System.out.println();
		System.out.println(" 2. 학생 성적 보기"); // 학생성적 보기
		System.out.println();
		System.out.println(" 3. 프로그램 종료"); // 프로그램 종료
		System.out.println();
		System.out.print(" 원하는 메뉴를 선택하세요.(1~3) : "); // 원하는 메뉴를 선택하세요
		
		int menu = 0;
		
		/*
		(1) . 아래의 로직에 맞게 코드를 작성하시오
		1. . 1~3 . 화면으로부터 메뉴를 입력받는다 메뉴의 값은 사이의 값이어야 한다
...
//				Student st = new Student(name, 1, 12, 80, 90, 70);
...
//				break;
				...
				try {
					String play = s.next();
					if (play.equalsIgnoreCase("Q") || play.equalsIgnoreCase("q")) {
						System.out.println("입력을 마치겠습니다.");
						break;
					} else {
						StringTokenizer st = new StringTokenizer(play, ",");
						String name = " ";
						int ban, no, kor, eng, math = 0;
		...
		System.out.println("총점 : "+koreanTotal+" "+englishTotal // 총점
		+" "+mathTotal+" "+total);
