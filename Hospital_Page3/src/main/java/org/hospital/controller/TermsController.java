...
import org.hospital.service.TermsService;
...
public class TermsController {
	...
	public String register(TermsVO vo, RedirectAttributes rttr) {
	...
	public void get(Long bno,  @ModelAttribute("cri") Criteria cri , Model model) {
		...
		model.addAttribute("terms", service.get(bno));
	}
	...
	@PostMapping("/modify")
	public String modify(TermsVO vo, @ModelAttribute("cri") Criteria cri, RedirectAttributes rttr) {
		log.info("modify : " + vo);
