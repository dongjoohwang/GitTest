	...
	<div class="login-body">
		<div class="login-form">
			<form action="my_page.do" method="post" name="my_page">
				...
				<a href="../hospitals/my_review.do?id=${member.id }"><button type="button" class="submit-btn">내가 쓴 리뷰</button></a>
				<input type="submit" value="정보 수정 / 탈퇴하기" class="submit-btn" id='update_member' onclick="return pwd_double()"><br>
			</form>
		</div>
	</div>
