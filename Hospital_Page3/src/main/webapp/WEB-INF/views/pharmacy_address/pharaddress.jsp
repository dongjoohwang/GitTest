...
<body>
<div id="map" style="width:80%; margin-left: 180px; margin-top: 100px; height:450px;"></div>
<div class="hi-btn" style="margin-top: 50px;">
	<a href="../hospitals/list.do"><button data-oper='list' class="hi hi-info">목록으로</button></a>
 </div>
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=	d959e79f3fd106a24922fe9adbe5f4c6&libraries=services"></script>
<script>
var mapContainer = document.getElementById('map'), // 지도를 표시할 div  
    mapOption = { 
	// x : 증가 => 위쪽 이동, y : 감소 => 아래쪽 이동 		// y : 증가 => 오른쪽 이동, 감소 => 왼쪽 이동

        center: new kakao.maps.LatLng(37.59332075603859, 127.01787912564315), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };
...
var positions = [
    {
        content: '<div>다올약국</div>', 	
     // x : 증가 => 위쪽 이동, y : 감소 => 아래쪽 이동 		// y : 증가 => 오른쪽 이동, 감소 => 왼쪽 이동
        latlng: new kakao.maps.LatLng(37.59332075603859, 127.01787912564315)
    }
    /* {
...
$("button[data-oper='list']").on("click", function(e) { // button[data-oper=' list']	=> 띄어쓰기도 에러로 인식
	...
	operForm.attr("action", "../pharmacy/list.do").submit();
});
