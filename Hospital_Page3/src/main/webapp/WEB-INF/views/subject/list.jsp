...
<script>
	...
	/* 	 	actionForm.append("<input type='hidden' name='bno' value='"+$(this).attr("href")"'>"); => 오류 */
			...
			/*
			if(actionForm.find("bno").val() == 1) {
				actionForm.attr("action", "../doctor1/get");
				actionForm.submit();
			}
			
			*/
			actionForm.attr("action", "../hospitals/list.do");
			actionForm.submit();
			})
