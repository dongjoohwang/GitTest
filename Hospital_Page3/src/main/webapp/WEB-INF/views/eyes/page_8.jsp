...
<%@include file ="../includes/header.jsp" %>
	<!-- 눈이 침침하고 시력이 떨어진것 같다 > 16세 이상 > 눈이 찔리거나 다쳤나요 (예,아니오) > 당뇨병,눈건조,눈툭튀,충혈,해당없음 모든선택지 > page_6의 모든선택지 > page_7의 모든 선택지 -->
	<h1>30cm 떨어진 위치에서 격자의 중심을 바라보세요.</h1>
	<h1>보기에서 해당되는 증상을 모두 선택하세요.</h1>
	<h1>중복 선택 가능</h1>

							<img src="${pagaContext.request.contextPath}/resources/assets/img/Amsler.png" />
						
	 
	<div class="login-body">
		<div class="login-form">
			<form action="../eyes/page_9.do" method="get">
