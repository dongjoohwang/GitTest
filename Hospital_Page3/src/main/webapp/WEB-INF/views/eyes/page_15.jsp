...
<%@include file ="../includes/header.jsp" %>
	...
	<div class="login-body">
		<div class="login-form"><!-- 여기서 암거나 골라도 11로 이동 -->
			<form action="../eyes/page_11.do" method="get">
				<input type="radio" name="symptom" value="1" id="1"/> <label for="1">진통제를 먹어도 통증이 가시지 않는다.</label> <hr>
				<input type="radio" name="symptom" value="2" id="2"/> <label for="2">눈을 움직이거나 깜빡이면 더 아프다.</label> <hr>
