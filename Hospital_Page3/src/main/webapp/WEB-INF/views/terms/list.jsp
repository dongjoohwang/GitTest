...
<div class="container">
	...
	<!-- 검색 조건 Start -->
	<div class="search">
		<form id="searchForm" action="/terms/list" method="get">
			<select name='type'>
				<option value=""
					<c:out value="${pageMaker.cri.type==null ? 'selected' : ''}"/>></option>
				<option value="T"
					<c:out value="${pageMaker.cri.type eq 'H' ? 'selected' : ''}"/>>제목</option>
				<option value="C"
					<c:out value="${pageMaker.cri.type eq 'A' ? 'selected' : ''}"/>>내용</option>
		...
		<tbody>
			<c:forEach items="${list }" var="terms">
				<tr class="odd gradeX">
					...
					<td><a class='move' href=<c:out value="${terms.bno}"/>>
							<c:out value="${terms.title}" />
					</a></td>
				</tr>
			</c:forEach>
		</tbody>
	...
	<form id="actionForm" action="/terms/list" method="get">
