	...
	<div class="detail">
		<div class="from-group">
			<label>번호</label> <input class="form-control" name="bno"
				readonly="readonly" value='<c:out value="${pharmacy.bno}"/>'><br>
		</div>
		<div class="from-group">
		...
		<div class="hi-btn">
			<a href="ph_list.do"><button data-oper='list' class="hi hi-info">목록으로</button></a>
...
<script>
	...
	$("button[data-oper='list']").on("click", function(e) { // button[data-oper=' list']	=> 띄어쓰기도 에러로 인식
		...
		operForm.attr("action", "/pharmacy/ph_list").submit();
	});
