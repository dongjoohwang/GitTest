...
//			
//			if(user != null) {
//				response.sendRedirect("getBoardsList.do");
//			} else {
...
//			response.sendRedirect("login.jsp");
//			
//		} else if (path.equals("/insertBoards.do")) {
...
//			response.sendRedirect("getBoardsList.do");
//			
//		} else if (path.equals("/updateBoards.do")) {
...
//			response.sendRedirect("getBoardsList.do");
//			
//		} else if (path.equals("/deleteBoards.do")) {
...
//			
//			BoardDAO boardDAO = new BoardDAO();
//			BoardVO boards = boardDAO.getBoards(vo);
//			
//			HttpSession session = request.getSession();
//			session.setAttribute("boards", boards);
//			response.sendRedirect("getBoard.jsp");
//			
//		} else if (path.equals("/getBoardsList.do")) {
